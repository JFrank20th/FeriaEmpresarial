...
public class FeriaEmpresarial {
    ...
    public String metodo1() {
        ...
        for (Puesto puesto : puestos) {
            if (puesto.estaOcupado() == true && puesto.darZona() == "Zona norte") {
               emp = puesto.darNombreEmpresa();
                for (Empresa empresa :empresas) {
                    if (empresa.darNombre().equals(emp) ) {
                        norte = norte + empresa.darNumeroPersonasAsistentes();
                    }
                }
            }
            else if (puesto.estaOcupado() == true && puesto.darZona() == "Zona oriente") {
                emp = puesto.darNombreEmpresa();
                for (Empresa empresa :empresas) {
                    if (empresa.darNombre().equals(emp) ) {
                        oriente = oriente + empresa.darNumeroPersonasAsistentes();
                    }
                }

            }
            else if (puesto.estaOcupado() == true && puesto.darZona() == "Zona sur") {
                emp = puesto.darNombreEmpresa();
                for (Empresa empresa :empresas) {
                    if (empresa.darNombre().equals(emp) ) {
                        sur = sur + empresa.darNumeroPersonasAsistentes();
                    }
                }

            }
            else if (puesto.estaOcupado() == true && puesto.darZona() == "Zona occidente") {
                emp = puesto.darNombreEmpresa();
                for (Empresa empresa :empresas) {
                    if (empresa.darNombre().equals(emp) ) {
                        occidente = occidente + empresa.darNumeroPersonasAsistentes();
                    }
                }

            }
            else if (puesto.estaOcupado() == true && puesto.darZona() == "Zona centro") {
                emp = puesto.darNombreEmpresa();
                for (Empresa empresa :empresas) {
                    if (empresa.darNombre().equals(emp) ) {
                        centro = centro + empresa.darNumeroPersonasAsistentes();
                    }
                }
        ...
        if (norte > sur && norte > oriente && norte > occidente && norte > centro) {
            comp = "norte es mayor";
        }else if (sur > norte && sur > oriente && sur > occidente && sur > centro){
            comp = "sur es mayor";
        }else if (oriente > norte && oriente > sur && oriente > occidente && oriente > centro){
            comp = "oriente es mayor";
        }else if (occidente > norte && occidente > oriente && occidente > sur && occidente > centro){
            comp = "occidente es mayor";
        }else if (centro > norte && centro > oriente && centro > occidente && centro > sur){
            comp = "centro es mayor";
        }
            return comp;
    }
    /**
    ...
    public String metodo2() {
        ...
        for (Puesto puesto : puestos) {
            if (puesto.estaOcupado() == true) {
                ...
                for (Empresa empresa : empresas) {
                    if (empresa.darNombre().equals(emp)) {
                        ocupacion = ocupacion + empresa.darNumeroPersonasAsistentes();
                    }
                }
            }
        }
        porcentaje = (ocupacion *100 )/maxExpositores;
        if (porcentaje>=60){
            mensaje = "El punto de equilibrio se ha cumplido";
        } else{
            mensaje = "El punto de equilibrio NO se ha cumplido";
        }
        return mensaje;
    }
